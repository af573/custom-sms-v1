...
import { Eye, EyeOff, Mail, Lock, Zap, Shield, Sparkles, ArrowRight, Star, CheckCircle } from "lucide-react"
          ...
          <div className="text-center animate-fadeIn">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <h1 className="text-6xl font-bold gradient-text-purple tracking-tight">Welcome Back</h1>
                <p className="text-2xl text-gray-300 font-light">Access your premium dashboard</p>
              </div>
