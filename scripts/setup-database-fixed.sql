...
BEGIN
    ...
    RAISE NOTICE '1. Create your first user by signing up through the application';
    RAISE NOTICE '2. Update the first user role to "owner" manually if needed';
    RAISE NOTICE '3. Configure email templates in Supabase Auth settings';
END $$;
